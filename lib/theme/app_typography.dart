...
class AppTypography {
  ...
  static final displayLarge = _style(
    size: 32,
    height: 38,
    weight: FontWeight.w600,
  );
  static final headingH1 = _style(
    size: 28,
    height: 34,
    weight: FontWeight.w600,
  );
  static final headingH2 = _style(
    size: 24,
    height: 30,
    weight: FontWeight.w600,
  );
  static final headingH3 = _style(
    size: 20,
    height: 26,
    weight: FontWeight.w600,
  );
  ...
  static final labelLarge = _style(
    size: 14,
    height: 20,
    weight: FontWeight.w500,
  );
  static final labelMedium = _style(
    size: 12,
    height: 16,
    weight: FontWeight.w500,
  );
